...
Within the calculated values we found that the data . . . to finish
...
I chose to create a figure that visualizes the crime proportions in police beats because it provides insights into the geographical distribution of crimes in Seattle. This figure consists of four smaller graphs because during the years which this dataset spans, 1975-2018, the police beats have been reconfigured three times. Each graph in the larger figure corresponded to one of these beats. Thus, this figure also depicts geographic changes in crime rates over time as well.
